...
class Info(commands.Cog):
    ...
    async def server_info(self, ctx):
        embed_var = discord.Embed(color=bot_db.embed_color[ctx.guid.id],  title=f'Server Information: {ctx.guild.name}')
        ...
        embed_var.add_field(name='Region:', value=ctx.guild.region, inline=False)
        embed_var.add_field(
        ...
        embed_var.set_thumbnail(url=ctx.guild.icon_url)
