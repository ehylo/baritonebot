...
class Responses:
    ...
    async def new_response(self, title: str, description: str, regex: str, delete: bool, ignored_ids: str):
        self.titles.append(title)
        self.descriptions.append(description)
        self.regexes.append(regex)
        self.deletes.append(delete)
        self.ignored_ids.append(ignored_ids)
        await self.db.update_responses(self.guild, self)
    ...
    async def delete_response(self, response_num_index: int):
        for item in [
