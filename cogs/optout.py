...
class Optout(commands.Cog):
    ...
    async def optout(self, ctx, *, arg=None):
        ...
        if arg is None:
            ...
            await channel_embed(ctx, 'Opt-Out', f'You will be **banned from this server** and **lose all your roles** by continuing. Are you sure you want to opt out? if yes, type `{values[0]}optout I am sure`')
